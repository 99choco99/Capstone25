...
{
	/// <summary>
	/// Converts the supported authoring-time argument values to and from their serialized representation.
	/// </summary>
	public static class DialogueArgumentCodec
	{
		private static readonly CultureInfo Invariant = CultureInfo.InvariantCulture;

		/// <summary>Returns the supported storage kind for a method parameter type.</summary>
		...
		/// <summary>Creates correctly shaped default values for a method descriptor.</summary>
		...
		/// <summary>Rebuilds arguments for a changed signature, optionally retaining compatible values.</summary>
		...
		/// <summary>Checks whether saved arguments can be invoked by a descriptor without executing it.</summary>
		...
		/// <summary>Decodes graph data into the positional argument array used for method invocation.</summary>
		...
		/// <summary>Decodes one saved argument while checking its parameter identity and value type.</summary>
		...
		/// <summary>Serializes a non-Unity-object value using invariant culture.</summary>
