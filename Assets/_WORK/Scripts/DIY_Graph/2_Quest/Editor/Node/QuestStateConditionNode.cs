...
namespace UniversalGraph.Quest.Editor
{
	...
	public sealed class QuestStateConditionNode : GraphNode<QuestStateConditionNodeData>
	{
		...
		{
			RefreshTitle();
			Port val = ((Node)this).InstantiatePort((Orientation)0, (Direction)0, (Port.Capacity)1, typeof(float));
			val.portName = "Input";
			((Node)this).inputContainer.Add((VisualElement)(object)val);
			Port val2 = ((Node)this).InstantiatePort((Orientation)0, (Direction)1, (Port.Capacity)0, typeof(float));
			val2.portName = "True";
			((Node)this).outputContainer.Add((VisualElement)(object)val2);
			Port val3 = ((Node)this).InstantiatePort((Orientation)0, (Direction)1, (Port.Capacity)0, typeof(float));
			val3.portName = "False";
