...
namespace UniversalGraph
{
	public static class DialogueEventRegistry
	{
		...
		private static object GetTargetInstance(DialogueMethodDescriptor descriptor, DialogueContext context)
		{
			...
			{
				Debug.LogWarning((object)("[Dialogue] '" + ((Object)val).name + "'??'" + descriptor.DeclaringType?.Name + "' 而댄룷?뚰듃媛\u0080 ?놁뒿?덈떎."), (Object)val);
				return null;
			}
			if (components.Length > 1)
			{
				Debug.LogError((object)("[Dialogue] '" + ((Object)val).name + "'??'" + descriptor.DeclaringType?.Name + "' 而댄룷?뚰듃媛\u0080 " + $"{components.Length}媛??덉뼱 ?\u0080?곸쓣 ?섎굹濡?寃곗젙?????놁뒿?덈떎."), (Object)val);
				return null;
			}
			return components[0];
		}
		...
		private static void LogInvocationException(string kind, string key, Exception exception, object instance)
		{
			...
			Object val = (Object)((instance is Object) ? instance : null);
